    ...
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.musicfont}>Genre</Text>
        ...
        <View style={styles.cntgenre}> 
          ...
          <View title = "Bohemian Rhapsody" style={styles.genredes}>
          <View style={styles.genre}>
          <Text style={styles.description}>Rock music is a genre of popular music that emerged in the mid-20th century, characterized by its strong rhythms, use of electric guitars, and energetic performances. Originating in the 1950s from earlier styles like blues, country, and rhythm and blues, rock music has evolved through various phases, including classic rock, punk rock, alternative rock, and hard rock. It typically features a band setup with electric guitars, bass, drums, and vocals, emphasizing raw energy, powerful melodies, and rebellious themes.Notable bands and artists like The Beatles, Led Zeppelin, Jimi Hendrix, and The Rolling Stones have been pivotal in shaping the genre, which spans a wide range of emotions and social commentary.Rock music continues to be a significant cultural force, influencing other musical genres and remaining a cornerstone of popular culture worldwide.</Text>
          </View>
